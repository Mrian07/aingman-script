...
function domain() {
    ...
    res1() {
        wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
        clear
    }
    res2() {
...
function Casper3() {
    ...
    echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
    wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
    clear
    ...
    echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
    wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
    clear
    ...
    echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
    wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/menu/m-update.sh && chmod +x m-update.sh && ./m-update.sh
    clear
