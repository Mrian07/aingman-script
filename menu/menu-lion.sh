...
function add_subdomain() {
    ...
    for sub in "${ADDR[@]}"; do
        ...
        wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/install/subdomain-lion.sh -O /tmp/subdomain-lion.sh
...
05 | 5) clear ; m-noobz ;;
06 | 6) clear ; m-trgo ;;
07 | 7) clear ; wget https://raw.githubusercontent.com/Mrian07/aingman-script/24.0/ex.sh && chmod +x ex.sh && ./ex.sh ;;
08 | 8) clear ; running ;;
